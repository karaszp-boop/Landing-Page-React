        ...
        <div className="home-content-container1">
          ...
          <div className="home-hero-text">
            <span className="home-text10">
              ...
              industrial applications. The company’s philosophy is built on four
              interconnected pillars – META, MOD, ANALYTICS, and implementation
              – which together form a complete cycle of world digitalization.
              Metamod Analytics W.L.L. bridges the physical and digital worlds
              into a unified, intelligent structure. Our goal is to transform
              data into knowledge, knowledge into decisions, and decisions into
              progress.
            </span>
          </div>
        </div>
          ...
          <div className="home-features-card1">
            ...
            <div className="home-text-container1">
              ...
              <span className="home-text12">
                ...
                imageryy and aerial or UAV LiDAR scanning, through mobile
                mapping, to ground-penetrating radar (GPR) methods for the
                passportization and digitalization of all visible physical
                reality. The objective is to create a comprehensive data
                foundation that captures reality in the highest possible
          ...
          <div className="home-features-card2">
            ...
            <div className="home-text-container2">
              ...
              <span className="home-text13">
                ...
                applications.Metamod Analytics processes data across multiple
                dimensions:* 1D – statistical and numerical data,* 2D –
                cartographic and vector data,* 3D – spatial models and digital
                twins,* 4D and higher dimensions – temporal, financial, and
                contextual data layers foradvanced interpretation.
              </span>
            </div>
          </div>
          <div className="home-features-card3">
            ...
            <div className="home-text-container3">
              ...
              <span className="home-text14">
                ...
                outcome is data-driven outputs ready for decision-making,
                planning, optimization, and strategic management — whether in
                urban governance, transportation infrastructure, or
      ...
      <div id="process" className="home-services">
        <div className="home-heading-container2">
          ...
          <span className="home-text16">
            ...
            visualization platforms, and supports data interoperability across
            various governance levels. The aim is to turn data into a dynamic
            decision-making ecosystem, rather than a static information
            repository.
          </span>
        </div>
          ...
          <div className="home-service-card1">
            ...
            <span className="home-text20">
              <span>
                ...
                dense urban spaces. Subsurface sensing for utilities and hidden
                infrastructure.
              </span>
        ...
        <div className="home-content-container7">
          ...
          <div className="home-locations-container">
            <div className="home-location1">
              <span className="home-heading7"> METAMOD ANALYTICS W.L.L</span>
              <div className="home-adress">
                ...
                <span>
                  <span>
                    Office 33, Building 114, Road 383, Block 316, Center
                    Building, Manama
                  </span>
                  <br></br>
              ...
              <div className="home-email2">
                ...
                <span className="Section-Text">info@meta-mod.com</span>
              </div>
      ...
      <div className="home-footer-container">
        <div className="home-footer">
          <div className="home-social-links">
            <svg viewBox="0 0 950.8571428571428 1024" className="home-icon61">
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="home-icon63">
              <path d="M713.143 73.143c90.857 0 164.571 73.714 164.571 164.571v548.571c0 90.857-73.714 164.571-164.571 164.571h-107.429v-340h113.714l17.143-132.571h-130.857v-84.571c0-38.286 10.286-64 65.714-64l69.714-0.571v-118.286c-12-1.714-53.714-5.143-101.714-5.143-101.143 0-170.857 61.714-170.857 174.857v97.714h-114.286v132.571h114.286v340h-304c-90.857 0-164.571-73.714-164.571-164.571v-548.571c0-90.857 73.714-164.571 164.571-164.571h548.571z"></path>
            </svg>
            <svg viewBox="0 0 877.7142857142857 1024" className="home-icon65">
          ...
          <div className="home-copyright-container">
            <span>© 2025 Metamod Analytics W.L.L, CR NO. 190200-1</span>
          </div>
        </div>
      </div>
